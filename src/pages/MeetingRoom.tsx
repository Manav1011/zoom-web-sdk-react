...
const MeetingRoom = () => {
  ...
  const { 
    host,meeting_url,meeting_id, userName, password, zak, meetingTopic, 
  ...
  async function startMeeting(host: boolean,signature: string, meetingNumber: any, passWord: any, userName: any, zak: any,height:number,width:number) {
    if (!meetingSDKRef.current) {
